...
\def\TPversion{\ctfileversion}
\def\TPdate{\ctfiledate}
...
\lstset{
	...
	classoffset=2,%
	alsoletter={-},%
	morekeywords={\ctshowlist,\ctsortasclist,\ctsortdeslist,\ctaddvalinlist,\ctremovevalinlist,\ctboolvalinlist,\cttestifvalinlist,\ctcountvalinlist,\ctminoflist,\ctmaxoflist,\ctmeanoflist,\ctsumoflist,\ctprodoflist,\ctreverselist,\ctgetvaluefromlist,\ctlenoflist,\ctgetindexfromlist,\ctsublist,\ctslicelist,\cttransformlist,\ctuniqlist,\ctintersectlists,\ctmergelists,\ctdifflist,\ctsymdifflist,\ctshufflelist,\ctshowlistwithsep,\ctgetvaluefromcycllist},%
...
\newtcblisting{DemoCode}[1]{%
	...
	listing options={%
		...
		classoffset=2,%
		alsoletter={-},%
		morekeywords={\ctshowlist,\ctsortasclist,\ctsortdeslist,\ctaddvalinlist,\ctremovevalinlist,\ctboolvalinlist,\cttestifvalinlist,\ctcountvalinlist,\ctminoflist,\ctmaxoflist,\ctmeanoflist,\ctsumoflist,\ctprodoflist,\ctreverselist,\ctgetvaluefromlist,\ctlenoflist,\ctgetindexfromlist,\ctsublist,\ctslicelist,\cttransformlist,\ctuniqlist,\ctintersectlists,\ctmergelists,\ctdifflist,\ctsymdifflist,\ctgetvaluefromcycllist,\ctshufflelist,\ctshowlistwithsep,\ctgetvaluefromcycllist},%
		keywordstyle={\color{green!50!black}},%
		classoffset=3,%
		morekeywords={asc,des},%
		keywordstyle={\color{orange}}
...
\begin{center}
    ...
    \\
    Thanks to Valentin Dao for his comments and improvements to the \hologo{LaTeX3} code.
	\end{tabular}
\end{center}
...
{\footnotesize\faBomb} Since version \texttt{0.20e}, the syntax is different for optional arguments that are \emph{not} the separator: rounding precision
(\ShowCode{\\cttransformlist}) and sorting keys \texttt{asc}/\texttt{des}
(\ShowCode{\\ctuniqlist}, \ShowCode{\\ctintersectlists}, \ShowCode{\\ctmergelists},
\ShowCode{\\ctdifflist}, \ShowCode{\\ctsymdifflist}) are no longer given between
square brackets \texttt{[...]}, but between angle brackets \texttt{<...>}. The
list separator itself stays between square brackets \texttt{[...]}, always in
first position (right after the star, if any).
...
\texttt{0.20e: Improvements with \textit{cyclic version}}

\texttt{0.20d: Improvements with \hologo{LaTeX3}, tks to \textit{ankaa3908} again !}
