...
\def\TPversion{\ctlegfileversion}
\def\TPdate{\ctlegfiledate}
...
\texttt{0.20e: Improvements in L3 version of package}

\texttt{0.20d: Improvements in L3 version of package}
