...
\title{The \textsf{lucide-icons} package (1.23.0) -- 05/07/2026}
\author{%
	Cédric Pierquet\\%
	\url{https://lucide.dev} (Source version 1.23.0)\\%
...
\hspace*{5mm}\fbox{\begin{minipage}{0.75\linewidth}{\emph{A set of 1745 free ISC License high-quality SVG/PDF icons for you to use in your web projects.}}\end{minipage}}
