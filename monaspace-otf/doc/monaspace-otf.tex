...
\title{Monaspace family fonts (\textit{experimental}) \\User’s Guide for LaTeX (v1.400)}
\author{Cédric Pierquet \\ \texttt{cpierquet@outlook.fr}}

\date{\today}
\newcommand*{\version}{1.400}
...
\subsection{Presentation (actual version is v1.400)}
...
\section{List of glyphs (Argon version)}

\displayfonttable{MonaspaceArgon-Regular}
