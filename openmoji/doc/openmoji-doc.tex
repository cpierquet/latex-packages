...
\title{The \textsf{openmoji} package (17.0.0) -- 06/07/2026}
\author{%
	Cédric Pierquet\\%
	\url{https://openmoji.org} (Source version 17.0.0)\\%
...
\hspace*{5mm}\fbox{\begin{minipage}{0.75\linewidth}{\emph{A set of 4485 CC-BY-SA-4.0 licensed high-quality SVG/PDF icons for you to use in your web projects.}}\end{minipage}}
...
\subsection{Color version (4485 icons)}
...
\subsection{Black version (4485 icons)}
