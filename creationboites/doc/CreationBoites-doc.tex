...
\begin{codehigh}[language=latex/latex2,style/main=cyan!10,style/code=cyan!10]
\begin{monenvt}[clés]<options tcbox>
...
\end{monenvt}
...
\begin{demohigh}[language=latex/latex2,style/main=cyan!10,style/code=cyan!10]
\begin{genintro}\lipsum[1][1]\end{genintro}

\begin{gencadre}\lipsum[2][1]\end{gencadre}

\begin{genprop}<width=0.5\linewidth,flush right>
\lipsum[3][1]
\end{genprop}
\end{demohigh}
...
\verb|v0.20e|~:~~~~correction d'un oubli avec les arguments optionnels des boîtes créées
